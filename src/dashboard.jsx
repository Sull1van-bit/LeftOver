                            ...
                            {deadstockAnalysisResult ? (
                                <Card className="p-6 bg-green-50 border border-green-200 shadow-lg">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        ...
                                        <div className="bg-white p-4 rounded-lg text-center shadow-sm md:col-span-2"><p className="text-sm text-gray-500">Sales Velocity</p><p className="text-2xl font-bold text-gray-800">{deadstockAnalysisResult.velocity}<span className="text-sm font-normal">/day</span></p></div>
                                    </div>
